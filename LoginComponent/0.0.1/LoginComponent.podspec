#
#  Be sure to run `pod spec lint LoginComponent.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "yangzhe" => "385609722@qq.com" }
  # Or just: s.author    = "yangzhe"
  # s.authors            = { "yangzhe" => "385609722@qq.com" }
  # s.social_media_url   = "http://twitter.com/yangzhe"
  ...
  s.exclude_files = "LoginComponent/Exclude"
